    ...
    <div class="product-container">
      <div class="swiper-inner2 swiper-container">
        <ul class="list swiper-wrapper">
          <li class="item swiper-slide" v-for="(newItemList, index) in newItemLists" :key="index">
            <a href="">
              <div class="img-wrap">
                <img :src="newItemList.listPicUrl" alt="">
              </div>
              <span class="name">{{newItemList.name}}</span>
              <span class="name-desc">{{newItemList.simpleDesc}}</span>
              <div class="name-price">
                <span>￥</span>
                <span>{{newItemList.retailPrice}}</span>
              </div>
            </a>
          </li>
