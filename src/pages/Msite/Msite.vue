        ...
        <div class="swiper-inner2 swiper-container">
          <ul class="list swiper-wrapper">
            <li class="item swiper-slide">
              <a href="">
                <div class="img-wrap">
                  <img src="./images/newProduct/01.png" alt="">
                </div>
                <span class="name">小龙虾 4-6钱 1千克/盒 （800克虾+200克汤）</span>
                <span class="name-desc">夏季爆品，媲美现煮</span>
    ...
    mounted () {
      this.$nextTick(() => {
        ...
        new Swiper('.topic-inner', {
          // initialSlide: 0,    //保证不会有默认的slide（尤其在一页有多个swiper时）
          autoheight: true,   //自动填充高度
